...
match Verify.run () with
| Verify.Yes -> ()
| Verify.No str ->
    print_string ("Verification failed: " ^ str ^ ".\n");
    exit 255
...
let tree =
  Add
    ( Add (Add (Fetch (Var 3), Var 4), Add (Var 1, Var 2)),
      Add (Add (Var 3, Var 4), Add (Var 1, Var 2)) )
;;
